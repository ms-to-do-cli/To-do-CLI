...
running command...
$ td (--version)
microsoft-to-do-cli/2.5.0 win32-x64 node-v16.13.0
$ td --help [COMMAND]
USAGE
  $ td COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/ms-to-do-cli/To-do-CLI/blob/v2.5.0/dist/commands/hello/index.ts)_
...
_See code: [dist/commands/i.ts](https://github.com/ms-to-do-cli/To-do-CLI/blob/v2.5.0/dist/commands/i.ts)_
...
_See code: [dist/commands/login.ts](https://github.com/ms-to-do-cli/To-do-CLI/blob/v2.5.0/dist/commands/login.ts)_
...
_See code: [dist/commands/logout.ts](https://github.com/ms-to-do-cli/To-do-CLI/blob/v2.5.0/dist/commands/logout.ts)_
